...
//  Lab 4
//
//  Created by Quin’darius Lyles-Woods on 9/18/19.
...
{
    //creates the sequence class with an empty sequence
    ...
    //adds a new item to a sequence but the item is added after the current item
